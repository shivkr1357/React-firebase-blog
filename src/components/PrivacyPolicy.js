      ...
      <Stack direction="row">
        ...
        <Box flex={4}>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to ItsIndianguy, the
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to ItsIndianGuy.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to ItsIndianGuy, accessible from{" "}
                <a
